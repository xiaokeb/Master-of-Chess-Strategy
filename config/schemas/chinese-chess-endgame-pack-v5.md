...
2026-09-26 在不改变上述格式的前提下追加 `xq-easy-009`、`010`，总数 16 关。
原十四关内容及会话版本不变。新主题“两步强制胜”要求玩家限步 2、无一步胜着、
穷举所有首着和黑方应手后恰有一个强制获胜首着；主变化只是一个示例，不能
单凭主变化通过就判定题目有效。后续着法不要求唯一。该主题允许按正式规则困毙获胜。
