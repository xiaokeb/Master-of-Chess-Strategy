...
备份恢复。扩展玩法已开放自由摆局、限时挑战、连胜模式与盲棋；盲棋沿用
标准规则，以阵营色背面隐藏棋种并关闭提示和悔棋；棋力评测提供五局自适应
定级和 400–2400 本地评分；定式学习提供规则引擎验证的分步讲解和指定开局
双 AI 自动演局。各扩展玩法复用正式 AI、存档、音效和
棋谱链路。个人中心已接入六段本地成长、分棋种统计、六枚成就与六套
项目自绘人物形象。当前残局资源是 5 关项目自编功能
